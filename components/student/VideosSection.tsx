    ...
    <section id="videos" className="scroll-mt-16 sm:scroll-mt-20 py-20 md:py-28 bg-transparent relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-8 max-w-6xl relative z-10">
        <div className="max-w-2xl mx-auto text-center mb-12">
          {/* Video Clip-art badge */}
          <div className="mx-auto w-24 h-24 sm:w-28 sm:h-28 rounded-3xl overflow-hidden shadow-lg border-2 border-purple-200 mb-4 bg-purple-50 hover:scale-105 transition-transform">
            <img
          ...
          <Badge
            variant="outline"
            className="mb-3 font-bold font-jolly text-xs sm:text-sm bg-purple-100/80 text-purple-800 border-purple-200 px-3.5 py-1 rounded-full shadow-xs"
          >
